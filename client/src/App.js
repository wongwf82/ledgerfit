...
class MyGiving extends Component {
  ...
  componentDidUpdate(nextProps) {
    if (
      nextProps.props.address != this.props.props.address &&
      ...
      return (
        <Tab.Pane>
          <div className="notfound">
            Address {this.props.props.address} not found
          </div>
        </Tab.Pane>
      );
          ...
          table.push(
            <tr>
              ...
              <td>
                ...
                <Button
                  small
                  onClick={self.show("tiny", result.data.in[i].hash)}
                >
                  Leave Remark
                </Button>
              </td>
      ...
      <div>
        <div className="announcement">
          <p style={{ float: "left", paddingLeft: "20px" }}>
            This is GreenLink's proof of concept for a Social Ledger and is an
            open source project. Visit GitHub and download the source code
          </p>
          <p
            className="icon-links"
            style={{ float: "right", paddingRight: "20px" }}
          >
            <a href="https://greenlink.io">
              <FontAwesomeIcon icon="link" />
            </a>
            <a href="https://github.com/greenlink-io/ledgerfit">
